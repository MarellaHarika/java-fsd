...
public class FlightsEntity {
	...
	public String toString() {
		return "FlightsEntity [ime=" + departureflightno=" + flightno + ", origin=" + origin + ", destination=" + destination + ", date="
				+ date + ", departure_t_time + ", arrival_time=" + arrival_time + ", fare=" + fare
				+ "]";
	}
